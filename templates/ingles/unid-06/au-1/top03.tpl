...
<div class="ba-esq">
    <div class="ba-balao">
        <p><a href="" title="Do you like to watch movies? And TV programs? What kinds (que tipos) of movies and TV programs do you know in English? See some examples">Você gosta de assistir a filmes? E os programas de TV? Que tipos de filmes e programas de TV que você sabe em Inglês? Veja alguns exemplos.</a></p>
...
<button  class="btn btn-info"  id="FeedbackOKButton" class="FuncButton" onfocus="FuncBtnOver(this)" onblur="FuncBtnOut(this)" onmouseover="FuncBtnOver(this)" onmouseout="FuncBtnOut(this)" onmousedown="FuncBtnDown(this)" onmouseup="FuncBtnOut(this)" onclick="HideFeedback(); return false;">&nbsp;OK&nbsp;</button>
</div>
</div>
