...
<div id="meio">
<h3><a href="" title="Foco na Gramática">Focus in Grammar</a></h3>
<div id="center">

<div id="atividade">
<h6>Vamos praticar agora o que você aprendeu sobre como fazer perguntas em inglês.</h6>
<h6><a href="" title="Complete the conversation with the words in the box.">Complete o dialogo com as palavras do quadro.</a></h6>
	<script src="js/atividade_top07.js" type="text/javascript"></script></head>
...
<b>A:</b> And how about <span class="GapSpan" id="GapSpan2"><input type="text" id="Gap2" onfocus="TrackFocus(2)" onblur="LeaveGap()" class="GapBox" size="6"></input></span>?<br />
<b>B:</b> Yes, I love it! I think it&#x2019;s <span class="GapSpan" id="GapSpan3"><input type="text" id="Gap3" onfocus="TrackFocus(3)" onblur="LeaveGap()" class="GapBox" size="6"></input></span>.     <br /><br />
</div>
</form>
</div>
