...
<div id="center">
	...
	<div id="box-atividade">
		<div class="ba-esq">
		    <div class="ba-balao">
		        <p>Nessa atividade veja o que tem no churrasco americano e marque o que também tem no churrasco brasileiro!</p>
		    </div>
...
<li class="QuizQuestion" id="Q_0" style="display: none;">
	...
	<ol class="MSelAnswers">
		...
		<li id="Q_0_3"><form method="post" action="" onsubmit="return false;"><div><input type="checkbox" id="Q_0_3_Chk" class="MSelCheckbox" />Macarrone cheese</div></form></li>
		<li id="Q_0_4"><form method="post" action="" onsubmit="return false;"><div><input type="checkbox" id="Q_0_4_Chk" class="MSelCheckbox" />Pork</div></form></li><li id="Q_0_5"><form method="post" action="" onsubmit="return false;"><div><input type="checkbox" id="Q_0_5_Chk" class="MSelCheckbox" />Beef</div></form></li>
	</ol>
