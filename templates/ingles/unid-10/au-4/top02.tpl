...
<div id="center">
	...
	<div class="swf">
		<h5>Veja o dialogo a seguir e depois responda as perguntas.</h5>
		<embed width="600" height="420" type="application/x-shockwave-flash" name="wmode" wmode="transparent"  src="swf/s01.swf" name="plugin"> 
	</div>
</div>
</div>	
{barra_tools}
