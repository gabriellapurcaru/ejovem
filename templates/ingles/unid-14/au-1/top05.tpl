...
<td align="center"> <label>
 ...
 <div  id="FeedbackDiv" style="width: 300px; height: 100px; background-color: #339900; display:none; position:absolute; left: 341px; top: 397px; border-radius: 05px "  >
 
  <center>
 <p id="reslt">  </p>
 
<button class="botOK"> OK </button></center>
</center>
  </div>
