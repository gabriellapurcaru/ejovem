...
<div id="box-center-conclusao">
    ...
    <div id="box-dir">
	<div id="texto">
	<p>Nessa aula aprendemos um pouco mais sobre os números e as horas, próxima lição iremos falar sobre os dias da semana.</p>
	<p><span class="label label-info"><a href="#" title="Vejo vocês em breve!"> See you soon!</a></span></p>
