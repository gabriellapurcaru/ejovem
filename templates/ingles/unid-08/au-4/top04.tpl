...
<div id="center">
<div id="swf">
<h6>Observe as imagens e marque a opções correta do que está sendo feito.</h6>
...
<li class="QuizQuestion" id="Q_0" style="display: none;"><div class="QuestionText"><img src="img/atividade_top04/img01.gif" width="100px" heigth="150px" style="margin-top:80px;margin-left:430px;" /></div>

<ol class="MCAnswers" style="margin-top:-160px;">
...
<li class="QuizQuestion" id="Q_1" style="display: none;"><div class="QuestionText"><img src="img/atividade_top04/img02.gif" width="100px" heigth="150px" style="margin-top:80px;margin-left:430px;" /></div>

<ol class="MCAnswers" style="margin-top:-160px;">


<li id="Q_1_0"><button class="FuncButton" onfocus="FuncBtnOver(this)" onblur="FuncBtnOut(this)" onmouseover="FuncBtnOver(this)" onmouseout="FuncBtnOut(this)"  onmousedown="FuncBtnDown(this)" onmouseup="FuncBtnOut(this)" id="Q_1_0_Btn" onclick="CheckMCAnswer(1,0,this)">&nbsp;&nbsp;?&nbsp;&nbsp;</button>&nbsp;&nbsp;Running</li>
...
<li class="QuizQuestion" id="Q_2" style="display: none;"><div class="QuestionText"><img src="img/atividade_top04/img03.gif" width="100px" heigth="150px" style="margin-top:80px;margin-left:430px;" /></div>

<ol class="MCAnswers" style="margin-top:-160px;">


<li id="Q_2_0"><button class="FuncButton" onfocus="FuncBtnOver(this)" onblur="FuncBtnOut(this)" onmouseover="FuncBtnOver(this)" onmouseout="FuncBtnOut(this)"  onmousedown="FuncBtnDown(this)" onmouseup="FuncBtnOut(this)" id="Q_2_0_Btn" onclick="CheckMCAnswer(2,0,this)">&nbsp;&nbsp;?&nbsp;&nbsp;</button>&nbsp;&nbsp;Playing the piano</li>
...
<li class="QuizQuestion" id="Q_3" style="display: none;"><div class="QuestionText"><img src="img/atividade_top04/img04.gif" width="100px" heigth="150px" style="margin-top:80px;margin-left:430px;" /></div>

<ol class="MCAnswers" style="margin-top:-160px;">


<li id="Q_3_0"><button class="FuncButton" onfocus="FuncBtnOver(this)" onblur="FuncBtnOut(this)" onmouseover="FuncBtnOver(this)" onmouseout="FuncBtnOut(this)"  onmousedown="FuncBtnDown(this)" onmouseup="FuncBtnOut(this)" id="Q_3_0_Btn" onclick="CheckMCAnswer(3,0,this)">&nbsp;&nbsp;?&nbsp;&nbsp;</button>&nbsp;&nbsp;Playing video games</li>
...
<li class="QuizQuestion" id="Q_4" style="display: none;"><div class="QuestionText"><img src="img/atividade_top04/img05.gif" width="200px" heigth="250px" style="margin-top:80px;margin-left:430px;" /></div>
...
<li class="QuizQuestion" id="Q_5" style="display: none;"><div class="QuestionText"><img src="img/atividade_top04/img06.gif" width="100px" heigth="150px" style="margin-top:80px;margin-left:430px;" /></div>

<ol class="MCAnswers" style="margin-top:-160px;">


<li id="Q_5_0"><button class="FuncButton" onfocus="FuncBtnOver(this)" onblur="FuncBtnOut(this)" onmouseover="FuncBtnOver(this)" onmouseout="FuncBtnOut(this)"  onmousedown="FuncBtnDown(this)" onmouseup="FuncBtnOut(this)" id="Q_5_0_Btn" onclick="CheckMCAnswer(5,0,this)">&nbsp;&nbsp;?&nbsp;&nbsp;</button>&nbsp;&nbsp;Reading</li>
...
<li class="QuizQuestion" id="Q_6" style="display: none;"><div class="QuestionText"><img src="img/atividade_top04/img07.gif" width="100px" heigth="130px" style="margin-top:80px;margin-left:430px;" /></div>

<ol class="MCAnswers" style="margin-top:-160px;">



<li id="Q_6_0"><button class="FuncButton" onfocus="FuncBtnOver(this)" onblur="FuncBtnOut(this)" onmouseover="FuncBtnOver(this)" onmouseout="FuncBtnOut(this)"  onmousedown="FuncBtnDown(this)" onmouseup="FuncBtnOut(this)" id="Q_6_0_Btn" onclick="CheckMCAnswer(6,0,this)">&nbsp;&nbsp;?&nbsp;&nbsp;</button>&nbsp;&nbsp;Painting</li>
...
<li class="QuizQuestion" id="Q_7" style="display: none;"><div class="QuestionText"><img src="img/atividade_top04/img08.gif" width="100px" heigth="150px" style="margin-top:80px;margin-left:430px;" /></div>

<ol class="MCAnswers" style="margin-top:-160px;">


<li id="Q_7_0"><button class="FuncButton" onfocus="FuncBtnOver(this)" onblur="FuncBtnOut(this)" onmouseover="FuncBtnOver(this)" onmouseout="FuncBtnOut(this)"  onmousedown="FuncBtnDown(this)" onmouseup="FuncBtnOut(this)" id="Q_7_0_Btn" onclick="CheckMCAnswer(7,0,this)">&nbsp;&nbsp;?&nbsp;&nbsp;</button>&nbsp;&nbsp;Singing</li>
