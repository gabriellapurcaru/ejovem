...
<div id="meio">
	<h3><a href="#">Atividade 05 - Tópico 03</a></h3>
		<div id="center">
		...
		<div id="box-atividade">
			<div class="ba-esq">
			<div class="ba-balao">
			        <p><h5><a class="" href="#">Responda ainda de acordo com a reportagem vista anteriormente.</h5></a></p>
			</div>
			...
			<div id="box-direita">
				<div id="atividade">
					<!-- -->
<script src="js/Aula09_a05_topico03.js" type="text/javascript"></script></head>
<h5>Tick the correct answer.</h5>
