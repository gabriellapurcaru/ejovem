...
we <span class="GapSpan" id="GapSpan2"><input style="width:100px;" type="text" id="Gap2" onfocus="TrackFocus(2)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> (ride PAST SIMPLE) on horses made of sticks.

<br />

He <span class="GapSpan" id="GapSpan3"><input style="width:100px;" type="text" id="Gap3" onfocus="TrackFocus(3)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> (wear PAST SIMPLE) black and I <span class="GapSpan" id="GapSpan4"><input style="width:100px;" type="text" id="Gap4" onfocus="TrackFocus(4)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> (wear PAST SIMPLE)white,
...
That awfull sound<br />Bang Bang,

<br />

My baby <span class="GapSpan" id="GapSpan7"><input style="width:100px;" type="text" id="Gap7" onfocus="TrackFocus(7)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> (shoot PAST SIMPLE)me down.

<br /><br />

Seasons <span class="GapSpan" id="GapSpan8"><input style="width:100px;" type="text" id="Gap8" onfocus="TrackFocus(8)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> (come PAST S) and <span class="GapSpan" id="GapSpan9"><input style="width:100px;" type="text" id="Gap9" onfocus="TrackFocus(9)" onblur="LeaveGap()" class="GapBox" size="7"></input></span> (change PAST SIMPLE) the time,
