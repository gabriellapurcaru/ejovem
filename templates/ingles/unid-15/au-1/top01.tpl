...
<p>Vamos revisar alguns tópicos para trazer à sua mente pontos estudados no passado. Lembra-se de que há algumas aulas sobre como dar informações e direções em inglês? Hoje, aplicaremos este conteúdo a alguns locais bastante conhecidos de Fortaleza. Vamos ao primeiro passo!</p>
<p><b>Vamos lá!</b></p>
	</div>
	</div>
