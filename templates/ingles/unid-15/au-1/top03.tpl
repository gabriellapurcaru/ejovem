...
<div id="box-esquerda">
	...
	<div class="ba-esq">
	    <div class="ba-balao">
        	<p>Vamos começar relembrando sobre as direções!</p>			                 
	    </div>
...
<span class="GapSpan" id="GapSpan4"><input style="width:25px;" type="text" id="Gap4" onfocus="TrackFocus(4)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> Take the first street on the right.<br />

<span class="GapSpan" id="GapSpan5"><input style="width:25px;" type="text" id="Gap5" onfocus="TrackFocus(5)" onblur="LeaveGap()" class="GapBox" size="6"></input></span> Go straight for two blocks.
