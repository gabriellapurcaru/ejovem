...
<div id="meio">
	<h3><a href="#" title="">Atividade 01 - Tópico 01</a></h3>
	<div id="center">
		<div id="atividade">
		<!-- -->
		<h5>Look at the pictures and choose the correct option.</h5>
		<script src="js/atividade_01_topico01.js" type="text/javascript"></script></head>
...
<td class="LeftItem" width="25%"><img src="img/Australia.gif" alt="Australia.gif" title="Australia" width="135" height="170" style="float: center;"></img></td>
							...
							<tr>
<td>
<select id="s6_6" style="width:90px;"><option value="x">Choice</option>
...
<td class="CenterItem" width="25%"><img src="img/64Z_china_ruler.gif" alt="64Z_china_ruler.gif" title="64Z_china_ruler" width="50" height="60" style="float: center;"></img></td>
<td class="LeftItem"><img src="img/6C1_greece_apollo.gif" alt="6C1_greece_apollo.gif" title="6C1_greece_apollo" width="60" height="70" style="float: center;"></img></td>
						</tr>
						<tr>
<td>
