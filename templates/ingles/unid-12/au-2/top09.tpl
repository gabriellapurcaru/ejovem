...
{menu}
	<div id="meio">
		...
		<div id="center">
			...
			<div class="swf">
				<h6>use a seta para continuar vendo a explicação.</h6>
				<embed width="600" height="420" type="application/x-shockwave-flash" name="wmode" wmode="transparent" src="swf/animacao03_top09.swf" name="plugin">
