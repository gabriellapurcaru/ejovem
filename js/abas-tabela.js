 ...
 *
 * March 3, 2010 - v1.1.3 ---- Added code to ensure that all vtab-content-panel elements are at least as tall as the tabColumn element.
...
(function($) {
	...
	$.fn.jVertTabs = function(attr,options) {
        ...
        return this.each(function() {
			...
			var tabColumn = tabRoot.children("div.vtab-tab-columns");
			var tabContentColumn = tabRoot.children("div.vtab-content-column");
			//tabColumnHeight = tabColumn.height();
			
			/* locate all li elements  */
			$(this).find(".vtab-tab-columns > ul > li").each(function(i){
			...
			$(this).children(".vtab-content-column > div.vtab-content-panel").each(function(i){
				if(i>0){
					$(this).hide();
				}		
			});
		...
		function handleTabClick(li,liIndex,tabRoot,doSelectedCallBack){
			...
			var tabCol = tabRoot.children("div.vtab-tab-columns");
			var tabContentCol = tabRoot.children("div.vtab-content-column");
			...
			tabContentCol.children("div.vtab-content-panel").each(function(i){
				$(this).hide();
				if(i == liIndex){
		...
		function getTotalTabsHeight(tabRoot){
			/* locate all li elements  */
			var height = 0;
			tabRoot.find(".vtab-tab-columns > ul > li").each(function(i){
		 ...
		 *
		 * tabContentCol - reference to the #vtab-content-column element
		 */
		...
		function setStyle(tabRoot){
			tabRoot.addClass("teste");
			tabRoot.children("div").eq(0).addClass("vtab-tab-columns");
			tabRoot.children("div").eq(1).addClass("vtab-content-column");
			tabRoot.children("div").eq(1).children("div").addClass("vtab-content-panel");
		};
		...
		function adjustMargin(tabRoot){			
			...
			$(tabRoot).children('div.vtab-content-column').css({"margin-left": tabColWidth-1 + "px"});
