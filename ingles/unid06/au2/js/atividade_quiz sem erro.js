...
I[0][2]='3';
I[0][3]=new Array();
I[0][3][0]=new Array('Go to school','',1,100,1);
I[0][3][1]=new Array('Do his homework','',1,100,1);
I[0][3][2]=new Array('Pay bills','',0,0,1);
I[0][3][3]=new Array('Organize his clothes','',1,100,1);
I[0][3][4]=new Array('Study English and Spanish','',1,100,1);
I[0][3][5]=new Array('Play soccer','',0,0,1);
...
//Add the hit readout
	Feedback =   'Você acertou ' + ' '  + Matches  + ' de ' + I[QNum][3].length + '<br />' + Feedback;
